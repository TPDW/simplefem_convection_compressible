...
real(8) mass,ke,gpe,ke_density,gpe_density     ! Various energies and energy components
real(8) thermal_energy_old,thermal_energy_change,ke2,gamma !
...
real(8) grpx,grpy,grvx,grvy,grpx_density       ! 
real(8) grpy_density,grvx_density,grvy_density ! 
...
real(8) dTdx_el,dTdy_el                        ! temperature gradients  
...
!viscosity = 2.5*1.d23*rho0/Ra

!hcapa = sqrt(Ra*viscosity*hcond/(Di*rho0**2*T0*Lx**2))


!End delete this later section
